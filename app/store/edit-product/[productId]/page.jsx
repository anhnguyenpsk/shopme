    ...
    return (
        <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Updating Product..." })} className="text-slate-500 mb-28">
            ...
            <div className="flex gap-5">
                ...
                <label htmlFor="" className="flex flex-col gap-2 ">
                    Quantity
                    <input type="number" name="quantity" onChange={onChangeHandler} value={productInfo.quantity} placeholder="0" min="0" className="w-full max-w-45 p-2 px-4 outline-none border border-slate-200 rounded" required />
                </label>
            </div>
