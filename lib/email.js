...
export async function sendVerificationEmail(email, code) {
  ...
  // Allow ignoring SMTP for example.com emails or specific test emails
...
export async function sendPasswordResetEmail(email, resetUrl) {
  ...
  if (lowerCaseEmail.endsWith('@example.com')) {
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('DEMO EMAIL - Password Reset Link');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log(`To: ${email}`);
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <head>
          ...
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <style>
            body { font-family: -apple-system, system-ui, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
            .container { background-color: #f9fafb; border-radius: 8px; padding: 30px; }
            .button { display: inline-block; background-color: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 20px 0; }
        ...
        <body>
          <div class="container">
            ...
            <p>You requested a password reset for your ShopMe account.</p>
