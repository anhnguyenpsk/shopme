...
|  7  | `parentId`      | Foreign Key, Nullable      | `text`         | ID danh mục cha (cho subcategories).              |
...
- `Category` 1-N `Category` (Một danh mục có thể có nhiều danh mục con - Subcategories)
...
- `Brand` 1-N `Product` (Thương hiệu có nhiều sản phẩm)
