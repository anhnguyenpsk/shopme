                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex-1 max-w-2xl mx-8">
                        ...
                        <div className="text-xs text-slate-500 mt-1 flex gap-3">
                            <Link href="/shop?search=Bộ phát WiFi" className="hover:text-green-500">Bộ phát WiFi</Link>
                            <Link href="/shop?search=iPhone 17" className="hover:text-green-500">iPhone 17</Link>
                            <Link href="/shop?search=Gaming mouse" className="hover:text-green-500">Chuột Gaming</Link>
                            <Link href="/shop?search=Đồng hồ thông minh" className="hover:text-green-500">Đồng hồ thông minh</Link>
                        </div>
                    </div>
