    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Trở thành hội viên", path: '/pricing', icon: null },
        ...
        },
        {
            title: "LIÊN HỆ",
            links: [
                { text: "+84-912-345-678", path: '/', icon: MailIcon },
                { text: "contact@shopme.com", path: '/', icon: PhoneIcon },
                { text: "11, Nguyễn Đình Chiểu, Quận 1", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Chào mừng bạn đến với shopme, điểm đến cuối cùng của bạn cho những tiện ích mới nhất và thông minh nhất. Từ điện thoại thông minh và đồng hồ thông minh đến các phụ kiện thiết yếu, chúng tôi mang đến cho bạn những điều tốt nhất trong sự đổi mới — tất cả ở một nơi.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © shopme Đã đăng ký bản quyền.
                </p>
            </div>
        </footer>
    );
