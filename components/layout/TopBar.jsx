                ...
                <div className="flex justify-between items-center h-9">
                    ...
                    <div className="flex items-center gap-4">
                        {session ? (
                            ...
                            <>
                                <Link href="/register" className="font-medium hover:text-green-500 transition-colors">Đăng ký</Link>
                                <div className="border-l h-3"></div>
                                <Link href="/login" className="font-medium hover:text-green-500 transition-colors">Đăng nhập</Link>
                            </>
                        )}
                    </div>
                </div>
